...
const video = require('./../assets/icons/video_bg.png');
const play1 = require('./../assets/icons/play1.png');
...
const SvgPlayIcon = ({style}) => <Image source={play} style={{ width: 18, height: 18, resizeMode: 'contain', tintColor: '#333', ...style }} /> //<SvgXml xml={player_play} fill="#000000"/>
...
const SvgReg = (style) => <Image source={register} style={{ width: 20, height: 32, tintColor:'#fff', ...style }} /> //<SvgXml xml={popup_help}/>
const SvgCNIC = (style) => <Image source={register} style={{ width: 20, height: 32, tintColor:'#21347E', ...style }} /> //<SvgXml xml={popup_help}/>
